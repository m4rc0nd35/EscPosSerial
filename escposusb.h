...
public:
    ...
    Q_ENUM(TransmitStatus)

    Q_INVOKABLE void printer();
    Q_INVOKABLE void getStatus(TransmitStatus);
    Q_INVOKABLE void setLineSpacing(int);
    Q_INVOKABLE void setFontSize(Size=defaultSize);
    Q_INVOKABLE void setFont(FontFamily);
    ...
    Q_INVOKABLE void qrCode(QString, Model, ModelSize, ErrorCorrection);
...
signals:
    void finishPrinter(QString msg);
    void printerFail(QString msg);
    void printerReady();
